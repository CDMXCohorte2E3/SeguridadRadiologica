...
INSERT INTO `admin` VALUES (1,'Leticia Somera','radiomed.asesores@gmail.com','RadioMed_01'),(2,'David Vargas','radiomed.contacto@gmail.com','RadioMed_01');
...
CREATE TABLE `orden` (
  ...
  PRIMARY KEY (`IdOrden`,`idUsuario`,`IdProducto`),
  KEY `fk_Ordenes_Productos1_idx` (`IdProducto`),
  KEY `fk_Ordenes_Usuario1_idx` (`idUsuario`),
  CONSTRAINT `fk_Ordenes_Productos1` FOREIGN KEY (`IdProducto`) REFERENCES `producto` (`idProducto`),
  CONSTRAINT `fk_Ordenes_Usuario1` FOREIGN KEY (`idUsuario`) REFERENCES `usuario` (`idUsuario`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb3;
/*!40101 SET character_set_client = @saved_cs_client */;
...
-- Dump completed on 2021-08-20 11:01:10
