        ...
        <img src="${producto.imagen}" class="card-img-top" alt="..."> 
            <div class="card-body"> 
                ...
                <div class="button text-center">      
                  <button class="btn btn-info btn-add-car" id="btn-add-car_${producto.id}" onclick="anadirCarrito(${producto.id});">Comprar</button>   
                </div>   
            </div> <!--card-body--> 
        </div><!--card--> 
        </div>`
...
function anadirCarrito(producto){
  ...
  var idProd = document.getElementById('btn-add-car_${producto.id}');



  anclaCart.innerHTML += ` <tr>
  <th scope="row" id="productoCarrito col-6">Titulo</th>
  <td class="col-3"><input type="number" value="1"></td>
  <td style="text-align: center;" class="col-3">

      <button type="button" class="btn btn-outline-danger" value="Delete Row"
